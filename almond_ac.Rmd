...
* 2) a (temp coefficient)
* 3) b (temp coefficient) 
* 4) c (precip coefficient) 
* 5) e (model intercept) 
...
cum_dist_lh <- plotecdf(sens_almond_cdf, col = "red", lwd = 5, 
...
### generate two examples of random number from parmeter distributions ####
  ...
  # naming parameters
  a = rnorm(mean = -0.015, sd = 0.20, n=np)
  b = rnorm(mean = -0.0046, sd = 0.20, n=np)
  c = rnorm(mean = -0.07, sd = 0.20, n=np)
  d = rnorm(mean = 0.0043, sd = 0.20, n=np)
  e = rnorm(mean = 0.28, sd = 0.20, n=np)
...
grid.arrange(boxplot_LH, boxplot_sobel, cum_dis_sobel, ncol = 2)
