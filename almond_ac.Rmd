...
* Both Sobol and LHS method show that the mean almond yield anomaly is the most sensitive to the precipitation^2 parameter(d), following by the precipitation parameter(c). 
* Both Sobol and LHS method show similar results distribution.
* Changing the simulation time from 1k to 2k does not have a significant impact on the sensitivity analyses results. However, there might be a difference when the number of simulation is even larger.
