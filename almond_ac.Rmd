...
Both the Sobol and LHS methods showed a similar results distribution. Additionally, both methods show that the mean mean almond yield anomaly is most sensitive to the precipitation^2 parameter(d), followed by the precipitation parameter(c). We did not observe a significant difference in the sensitivity analysis results for either method afteer changing the simulations runs from 1k to 2k.However, there might be a difference when the number of simulation is even larger.
